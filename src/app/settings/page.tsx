          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl font-semibold">
                Ajusta la experiencia de tu biblioteca
              </h1>
              <p className="text-muted-foreground text-sm">
                Controla accesos, notificaciones, integraciones y todo lo que
                define tu espacio de lectura.
              </p>
            </div>
          ...
          <aside className="space-y-4">
            <Card className="p-5">
              <CardHeader className="p-0 pb-4">
                ...
                <CardDescription>
                  Accede a cada configuración por sección.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="p-5">
              ...
              <CardContent className="space-y-3 p-0">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">Backup inteligente</span>
          ...
          <div className="space-y-8">
            ...
            <section id="apariencia" className="space-y-4">
              ...
              <Card>
                <CardContent className="grid gap-4 md:grid-cols-2">
                  ...
                  <Checkbox label="Activar modo lectura nocturna" defaultChecked />
            ...
            <section id="privacidad" className="space-y-4">
              ...
              <Card>
                <CardContent className="grid gap-4 md:grid-cols-2">
                  <Checkbox
                    label="Compartir estadísticas con el club"
                    defaultChecked
                  />
                  <Checkbox label="Mostrar progreso en el perfil público" />
                  <Checkbox
                    label="Permitir invitaciones a lecturas colaborativas"
                    defaultChecked
                  />
                  <Checkbox label="Ocultar historial de audiolibros" />
                </CardContent>
              </Card>
            </section>
